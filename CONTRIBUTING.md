...
Fork https://github.com/schl4win3r/schlawiner-engine-kotlin into your GitHub account.

## Clone your newly forked repository onto your local machine

```bash
git clone git@github.com:[your username]/schlawiner-engine-kotlin.git
cd schlawiner-engine-kotlin
```
...
```bash
git remote add upstream git://github.com/schl4win3r/schlawiner-engine-kotlin.git
```
 ...
 * Issue Tracker - https://github.com/schl4win3r/schlawiner-engine-kotlin/issues
